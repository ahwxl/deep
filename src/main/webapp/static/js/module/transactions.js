var mygridtab = $('#transactions').dataTable({
                ...
                "aoColumnDefs": [{
                        ...
                        fnRender: function (setobj, data) {
                        	var htmlstr = "<a class=' btn green' name='showProcessImage' id='stockId'  1data-toggle='modal' procDefId='"+setobj.aData['stockId']+"' href='javascript:void(0)' trigger='alert('0000')'>流程</a>&nbsp;";
